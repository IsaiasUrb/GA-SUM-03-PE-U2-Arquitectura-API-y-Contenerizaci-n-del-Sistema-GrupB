  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Panel de Trabajador</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        {[
          { label: 'Incidencias asignadas', valor: 0, color: 'bg-orange-500' },
          { label: 'En proceso', valor: 0, color: 'bg-blue-500' },
          { label: 'Resueltas hoy', valor: 0, color: 'bg-green-500' },
        ].map((t) => (
      ...
      <div className="bg-white rounded-2xl shadow-sm p-5">
        <h2 className="text-lg font-semibold text-gray-700 mb-3">Incidencias pendientes</h2>
        <p className="text-gray-400 text-sm">No hay incidencias asignadas.</p>
      </div>
    </div>
  );
}
