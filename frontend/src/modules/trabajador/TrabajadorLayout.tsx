...
export default function TrabajadorLayout() {
  return (
    <RoleLayout
      menuItems={menuItems}
      titulo="Trabajador"
      colorFondo="bg-orange-950"
      colorActivo="bg-orange-600"
      colorHover="hover:bg-orange-800/50"
      colorBorde="border-orange-800"
      colorTexto="text-orange-400"
      colorSubtexto="text-orange-200/60"
